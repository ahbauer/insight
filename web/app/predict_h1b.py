...
def predict_nH1B(date=pandas.to_datetime('2014-02-01')):
    regr = joblib.load('/Users/bauer/insight/teleborder/web/data/my_model.pkl')
    (sents_model, sp500_model, empl_model, trend_model) = joblib.load('/Users/bauer/insight/teleborder/web/data/xdata.pkl')
    norms = joblib.load('/Users/bauer/insight/teleborder/web/data/norms.pkl')
    ...
    return prediction, norms[4:]

def make_figure(date=pandas.to_datetime('2014-02-01'), pred=80000):
    
    (prediction_series,month_series) = joblib.load('/Users/bauer/insight/teleborder/web/data/pred.pkl')
    # fig = plt.Figure()
    ...
    fig = plt.figure()
    #ax0 = fig.add_subplot(111)
    plt.axvline(date + datetime.timedelta(days=30),color='black')
